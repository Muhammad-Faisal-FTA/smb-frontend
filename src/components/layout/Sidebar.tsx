...
export function Sidebar({ currentPage, onNavigate, isMobileOpen, onMobileClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`fixed left-0 top-0 h-screen w-64 flex flex-col z-50 transition-transform duration-300 lg:translate-x-0 ${
      ...
      <div className="p-6" style={{ borderBottom: '1px solid #D1D5DB' }}>
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 style={{ color: '#111827' }}>FinancePulse</h2>
              <p style={{ color: '#4B5563' }}>Financial Intelligence</p>
            </div>
          </div>
          <button 
            onClick={onMobileClose}
