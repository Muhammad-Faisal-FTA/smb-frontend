      ...
      {isExpanded && (
        <div className="p-6 pt-0 border-t border-slate-200">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-slate-700 mb-2">Operating Expenses (Monthly)</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-slate-700 mb-2">Rent & Utilities (Monthly)</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-slate-700 mb-2">Payroll (Monthly)</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-slate-700 mb-2">Marketing Spend (Monthly)</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-slate-700 mb-2">Inventory Purchases (Monthly)</label>
              <input
                type="number"
                value={formData.inventoryPurchases}
                onChange={(e) => handleChange('inventoryPurchases', e.target.value)}
                className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                placeholder="0.00"
              />
            </div>
            <div>
              <label className="block text-slate-700 mb-2">Loan Installments (Monthly)</label>
              <input
                type="number"
                value={formData.loanInstallments}
                onChange={(e) => handleChange('loanInstallments', e.target.value)}
                className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                placeholder="0.00"
              />
            </div>
            <div>
              <label className="block text-slate-700 mb-2">Tax Payments (Monthly)</label>
              <input
                type="number"
          ...
          <div className="flex items-center justify-end gap-3 mt-6 pt-6 border-t border-slate-200">
            <button
              onClick={() => setFormData({
                operatingExpenses: '', rentUtilities: '', payroll: '', marketingSpend: '',
                inventoryPurchases: '', loanInstallments: '', taxPayments: '',
              })}
