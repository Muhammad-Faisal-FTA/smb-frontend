    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-slate-600">
            Advanced forecasting and predictive analytics for your business
          </p>
        </div>
      </div>
        ...
        <div className="flex items-start gap-4 mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-blue-100 leading-relaxed">
              Our AI has analyzed 6 months of financial data, identifying key
              trends and generating predictive models. Based on current
              patterns, your business is positioned for{" "}
              <strong>sustained growth</strong> with a projected 15% revenue
              increase over the next quarter. However, expense management
              requires attention to maintain optimal profit margins.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
          <div className="mb-6">
            ...
            <p className="text-slate-600">
              3-month projection based on historical trends
            </p>
          </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
          <div className="mb-6">
            ...
            <p className="text-slate-600">
              Predicted spending patterns and trends
            </p>
          </div>
      ...
      <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
        <div className="mb-6">
          ...
          <p className="text-slate-600">
            Expected, optimistic, and pessimistic scenarios
          </p>
        </div>
                ...
                <div className="flex items-start justify-between mb-2">
                  <div className="flex items-center gap-2">
                    <AlertTriangle
                      className={`w-5 h-5 ${
                        severityIcons[
                          anomaly.severity as keyof typeof severityIcons
                        ]
                      }`}
                    />
